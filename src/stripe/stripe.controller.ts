...
export class StripeController {
  ...
  @Post('create-product')
  async createProduct(@Body('name') name: string, @Body('description') description: string) {
  ...
  async createNewPrice(
    ...
    return this.stripeService.createNewPriceForProduct(productId, amount, interval);
  }
}